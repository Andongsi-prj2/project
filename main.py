...
async def get_realtime_metrics():
    ...
    try:
        ...
        if messages:
            ...
            # Kafka 데이터가 없을 때 기본 데이터 반환
            print("Kafka 데이터 없음 - 기본 데이터 반환")
            return {
                "data": [
                    {
                        ...
                        "total_quantity": 5000,
                        "active_factories": 3,
                        "temperature": "TEMP_25.0C",
                        "voltage": "VOLTAGE_15.0V",
                        "ph_level": "PH_2.0",
                        "status": "1"
                    }
                ],
                "message": "Kafka 데이터 없음, 기본 데이터 반환",
                "status": "no_data"
            }
